...
test("all operation outputs have concrete schemas that reject incompatible payloads", () => {
  ...
  const valid = {
    ...
    pluggy_source_activation_readiness: { source: "PLUGGY", generatedAt, currentMode: "MANUAL", candidateMode: "PLUGGY", status: "BLOCKED", canActivatePluggy: false, canSwitchToPluggy: false, manualCrudStatus: "DISABLED", manualCrud: { transactions: "DISABLED", funds: "DISABLED", reason: "Revisão necessária" }, reconciliation: { status: "DIVERGENTE", considered: false, baseline: "PLUGGY_ONLY_SANDBOX" }, comparison: { status: "DIVERGENTE", totalValueDelta: 0, investedValueDelta: 0, cashBalanceDelta: 0, positionValueDelta: 0, byTicker: [] }, blockers: [], warnings: [], nextAction: "Revisar" },
