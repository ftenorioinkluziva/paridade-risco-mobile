...
const definitions = [
  ...
  ["pluggy_migration_readiness", "Pluggy migration readiness: current source, reconciliation, blockers and next action.", "/api/integrations/pluggy/migration-readiness", "GET", emptyInputSchema, pluggyMigrationReadinessSchema],
