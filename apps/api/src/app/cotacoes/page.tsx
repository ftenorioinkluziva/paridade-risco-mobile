...
export default function CotacoesPage() {
  ...
  return (
    <AuthGuard>
      <Screen pageId="cotacoes" width="wide" title="Cotações" subtitle="ETFs estratégicos acompanhados por consulta automática e fonte alternativa.">
        <section style={styles.operationalPanel} aria-live="polite">
          <div style={styles.operationalHeader}>
            <div style={styles.liveStatusCopy}>
              ...
              <span style={styles.liveStatusText}>Consulta a cada 7 minutos durante o pregão, com captura final às 17:30.</span>
              {lastRefreshAt ? (
          ...
          <div style={styles.summaryGrid}>
            ...
            <SummaryMetric label="Agenda" value="7 min · fechamento 17:30" />
          </div>
        </section>
